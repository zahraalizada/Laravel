    ...
    $('#btnLogin').click(function () {
        ...
        if (email.trim() == '') {
            Swal.fire({
                icon: 'info',
                title: 'Uyari!',
                text: 'Email bos birakilmaz!',
            })
        } else if (!emailControl(email)) {
            // alert('Gecerli bir email adresi yazin');
            Swal.fire({
                icon: 'info',
                title: 'Uyari!',
                text: 'Gecerli bir email adresi yazin!',
            })
        } else if (password.trim() == '') {
            // alert('Parola bos birakilamaz');
            Swal.fire({
                icon: 'info',
                title: 'Uyari!',
                text: 'Parola bos birakilamaz!',
            })
        } else{
            $('#loginForm').submit();
        }
